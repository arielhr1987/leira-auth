 ...
 * @constructor
 */
registerBlockType('leira-auth/forgot-password', {
	 ...
	 * @param {boolean} attributes.show_login - Show "Forgot password" link
	 * @param {string} attributes.login_label - "Forgot password" link label
